...
namespace Company.Web.Controllers
{
    public class UserController : Controller
    {
        ...
        [HttpPost]
        public async Task <IActionResult> Update(string? id, UserUpdateViewModel userUpdateView)
        {
            if (id != userUpdateView.Id)
            {
                return NotFound();
            }
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    user.NormalizedUserName = userUpdateView.UserName.ToUpper();
